...
Python on macOS needs certificates for secure internet connections:

1. Go to **Applications** > **Python 3.x** folder
2. Double-click **Install Certificates.command**
3. A Terminal window will open and install certificates
4. Close the window when it says "Process completed"

<Warning>
  Skip this step and you'll get SSL errors when Python tries to download packages or access HTTPS websites.
</Warning>
...
<Card
  title="Continue to VS Code setup"
  icon="arrow-right"
